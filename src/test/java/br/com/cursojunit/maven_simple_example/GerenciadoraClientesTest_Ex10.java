package br.com.cursojunit.maven_simple_example;
...
public class GerenciadoraClientesTest_Ex10 {
	...
	@Test(expected = IdadeNaoPermitidaException.class, timeout = 1000)
	public void testClienteIdadeAceitavel_06() throws IdadeNaoPermitidaException {
		
		/* ========== Montagem do Cen�rio ========== */		
		Cliente cliente = new Cliente(1, "Gustavo", 64, "guga@gmail.com", 1, true);
